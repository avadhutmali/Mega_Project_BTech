...
**[⬇ Download IdleGridAgent-windows.zip](IdleGridAgent-windows.zip)** *(or [Download via GitHub](https://github.com/avadhutmali/Mega_Project_BTech/raw/main/agent/IdleGridAgent-windows.zip))*
